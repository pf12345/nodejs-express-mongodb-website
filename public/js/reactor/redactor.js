...
(function ($) {
    ...
    Redactor.prototype = {
        ...
        uploadFrame: function () {
            ...
            d.innerHTML = '<iframe style="display:none" id="' + this.id + '" name="' + this.id + '"></iframe>';
            $(d).appendTo("body");
        ...
        oldIE: function () {
            return !!(this.browser('msie') && parseInt(this.browser('version'), 10) < 9);
        },
        ...
        isMobile: function (ipad) {
            ...
            else return !!/(iPhone|iPod|BlackBerry|Android)/.test(navigator.userAgent);
        }
    };
